...
@router.post("/register", response_model=models.UserInDB, status_code=status.HTTP_201_CREATED)
...
def read_users_me(current_user: models.UserInDB = Depends(auth.get_current_user)):
    return current_user
